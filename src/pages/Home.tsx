...
export function Home() {
  return (
    <div className="w-full">
      {/* Launch Promo Banner */}
      <div className="bg-gold text-[#0B0F14] py-3 text-center font-semibold text-sm">
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {playbooks.map((playbook) => (
                <Card 
                  key={playbook.id} 
                  className="hover:shadow-xl transition-shadow duration-300 border-2 hover:border-[#0B0F14]"
                >
                  <CardHeader>
                  ...
                  <CardFooter className="flex flex-col gap-2">
                    <div className="w-full flex items-center justify-between">
                      ...
                      <Button asChild style={{ backgroundColor: playbook.color, color: '#0B0F14' }} className="hover:opacity-90">
          ...
          <div className="max-w-2xl mx-auto text-center space-y-8">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <Input 
                ...
                className="bg-white text-[#0B0F14] flex-1"
              />
              <Button type="submit" size="lg" className="bg-gold text-[#0B0F14] hover:bg-gold/90">
                Subscribe
              </Button>
            </form>
