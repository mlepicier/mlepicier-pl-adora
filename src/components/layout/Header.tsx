    ...
    <header className="sticky top-0 z-50 w-full border-b bg-[#0B0F14] text-white backdrop-blur supports-[backdrop-filter]:bg-[#0B0F14]/95">
      <div className="container flex h-16 items-center justify-between px-4">
        <Link to="/" className="flex items-center space-x-2">
          <span className="text-2xl font-bold">PlayLabs.ai</span>
        </Link>
        ...
        <nav className="hidden md:flex gap-6 items-center">
          ...
          <Link to="/playbooks" className="text-sm font-medium hover:text-gold transition-colors">
            Playbooks
          </Link>
          <Link to="/pricing" className="text-sm font-medium hover:text-gold transition-colors">
            Pricing
          </Link>
          <Link to="/free-gpt" className="text-sm font-medium hover:text-gold transition-colors">
            Free GPT
          </Link>
          <Link to="/about" className="text-sm font-medium hover:text-gold transition-colors">
            About
          </Link>
          <Link to="/faq" className="text-sm font-medium hover:text-gold transition-colors">
            FAQ
          </Link>
          <Button asChild className="bg-gold text-[#0B0F14] hover:bg-gold/90">
